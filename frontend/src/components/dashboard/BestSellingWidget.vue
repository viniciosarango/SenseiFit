...
<template>
    <div class="card">
        <div class="flex justify-between items-center mb-6">
            <div class="font-semibold text-xl">Seguimineto de cupones</div>
            <div>
        ...
        <ul class="list-none p-0 m-0">
            ...
            <li class="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
                <div>
                    <span class="text-surface-900 dark:text-surface-0 font-medium mr-2 mb-1 md:mb-0">Cupones creados</span>
            ...
            <li class="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
                <div>
                    <span class="text-surface-900 dark:text-surface-0 font-medium mr-2 mb-1 md:mb-0">Cupones no obtenidos</span>
                    <div class="mt-1 text-muted-color">Vistos pero no descargados</div>
                </div>
